...
public class ShopView extends JFrame implements ActionListener, KeyListener{
	...
	private void ShopView() {
		...
		mostrarInventario = new JButton("5. Mostrar Inventario ");
		mostrarInventario.setBounds(6, 175, 195, 29);
		mostrarInventario.addActionListener(this); 
		mostrarInventario.addKeyListener(this); 
		mostrarInventario.setFocusable(false); 
		contentPane.add(mostrarInventario);

		eliminarProducto = new JButton("9. Eliminar producto");
		eliminarProducto.setBounds(6, 216, 190, 29);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == contarCaja) {
			...
			deleteProduct();
		} else if (e.getSource() == mostrarInventario) {
			getInventoryData();
		}
	}
